...
using SearchService.DataLibrary.DataAccess;
...
namespace SearchService.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "SearchService.API", Version = "v1" });
            });

            services.AddTransient<ISqlDataAccess, SqlDataAccess>();
            services.AddTransient<IEventData, EventData>();
            services.AddTransient<ISearchData, SearchData>();
        }
